...
$string['manualmaxreferences'] = 'You can save up to 3 manual grading references.';
$string['manualsaved'] = 'Manual grade saved.';
$string['manualupdated'] = 'Manual grade updated.';
...
$string['resultnotready'] = 'The result is not ready to publish yet.';
$string['resultpublished'] = 'Result published.';
...
$string['assistant:intro'] = 'Your teacher published feedback for your VPL programming activities, generated with AI to help you improve your next submissions.';
$string['assistant:current'] = 'This activity';
$string['assistant:viewfeedback'] = 'View full feedback';
$string['assistant:originai'] = 'AI graded';
$string['assistant:originteacher'] = 'Teacher reviewed';
$string['phase:gradedai'] = 'Graded by AI';
$string['phase:reviewed'] = 'Reviewed by teacher';
$string['phase:modified'] = 'Modified by teacher';
$string['assistant:breakdown'] = 'Criteria breakdown';
$string['assistant:generalcomment'] = 'General comment';
$string['assistant:otheractivities'] = 'Other activities';
$string['assistant:openfull'] = 'Open your VPL activity editor to see your full feedback here.';
$string['criterion:adjusted'] = 'Adjusted by the teacher';
...
$string['feedback:originlabel'] = 'Grade origin';
$string['feedback:originai'] = 'AI graded';
$string['feedback:originteacher'] = 'Reviewed by teacher';
$string['feedback:originaihelp'] = 'This grade and feedback were generated by AI and published by your teacher. Your teacher has not reviewed them manually yet.';
$string['feedback:originteacherhelp'] = 'Your teacher reviewed the AI evaluation and confirmed or adjusted this grade and feedback before publishing it.';
...
$string['feedback:general'] = 'General comment';
$string['feedback:nogeneral'] = 'There is no general comment for this submission.';
