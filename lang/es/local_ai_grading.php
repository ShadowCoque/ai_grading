...
$string['assistant:intro'] = 'Tu docente publicó retroalimentación para tus actividades de programación VPL, generada con IA para ayudarte a mejorar tus próximas entregas.';
$string['assistant:current'] = 'Esta actividad';
$string['assistant:viewfeedback'] = 'Ver retroalimentación completa';
$string['assistant:originai'] = 'Calificado por IA';
$string['assistant:originteacher'] = 'Revisado por docente';
$string['phase:gradedai'] = 'Calificado por IA';
$string['phase:reviewed'] = 'Revisado por docente';
$string['phase:modified'] = 'Modificado por docente';
$string['assistant:breakdown'] = 'Desglose por criterio';
$string['assistant:generalcomment'] = 'Comentario general';
$string['assistant:otheractivities'] = 'Otras actividades';
$string['assistant:openfull'] = 'Abre la edición de tu actividad VPL para ver aquí tu retroalimentación completa.';
$string['criterion:adjusted'] = 'Ajustado por el profesor';
...
$string['feedback:originlabel'] = 'Origen de la calificación';
$string['feedback:originai'] = 'Calificado por IA';
$string['feedback:originteacher'] = 'Revisado por el profesor';
$string['feedback:originaihelp'] = 'Esta calificación y retroalimentación fueron generadas por la IA y publicadas por tu docente. Tu docente todavía no las revisó manualmente.';
$string['feedback:originteacherhelp'] = 'Tu docente revisó la evaluación de la IA y confirmó o ajustó esta calificación y retroalimentación antes de publicarla.';
...
$string['feedback:general'] = 'Comentario general';
$string['feedback:nogeneral'] = 'No hay un comentario general para esta entrega.';
